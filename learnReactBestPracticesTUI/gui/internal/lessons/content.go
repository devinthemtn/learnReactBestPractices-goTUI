	...
	return models.Lesson{
		...
		Content: []models.ContentSection{
			...
			},
			{
				...
				Content: "[YES] Project title and brief description\n[YES] Installation/setup instructions\n[YES] Quick start guide\n[YES] Basic usage examples\n[YES] Link to detailed documentation\n[YES] License and contribution info\n\n[NO] Detailed API documentation\n[NO] Architecture explanations\n[NO] Troubleshooting guides\n[NO] Change logs",
			},
			{
				Title:   "What Goes in doc/ Folder",
				Type:    models.ContentTypeExample,
				Content: "[YES] API documentation and examples\n[YES] Architecture and design decisions\n[YES] Detailed setup and deployment guides\n[YES] Troubleshooting and FAQ\n[YES] Contributing guidelines\n[YES] Change logs and release notes\n[YES] User guides and tutorials",
			},
		},
		Examples: []models.ProjectExample{
			{
		...
		Content: []models.ContentSection{
			{
				...
				Type:    models.ContentTypeText,
				Content: "[AVOID] Organizing by file type instead of feature\n[AVOID] Deeply nested folders (more than 3-4 levels)\n[AVOID] Generic component names (Card.jsx, Item.jsx)\n[AVOID] God files (one file does everything)\n[AVOID] Duplicate code across projects",
			},
		},
		Examples: []models.ProjectExample{
			{
